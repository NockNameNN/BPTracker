...
export const TASKS: Task[] = [
  ...
  { id: 14, name: "10 действий на ферме", bpWithoutVip: 1, bpWithVip: 2, difficulty: "Средне" },
  ...
  { id: 17, name: "Проехать 1 уличную гонку (от 1000$)", bpWithoutVip: 1, bpWithVip: 2, difficulty: "Быстро" },
  ...
  { id: 33, name: "Поймать 20 рыб", bpWithoutVip: 4, bpWithVip: 8, difficulty: "Средне", extraCondition: "Нужна удочка и приманка" },
